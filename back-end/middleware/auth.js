...
module.exports = (req, res, next) => {
    ...
    const admin = decodedToken.admin //decoder le token de l'admin
    ...
    req.auth = { userId , admin} ; //racourcie pour attribuer un valeur a une clée du mm nom d'un objet,extensible , ajouter des element a l'avenir
